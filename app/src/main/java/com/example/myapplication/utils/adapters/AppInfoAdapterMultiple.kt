...
class AppInfoAdapterMultiple(private val list: ArrayList<AppInfo>) : RecyclerView.Adapter<AppInfoAdapterMultiple.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.cardview_app_multiple, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val checkIcon: ImageView = view.findViewById(R.id.check)
        ...
        fun bind(app: AppInfo) {
            ...
            else checkIcon.visibility = View.INVISIBLE
        }
    }
}